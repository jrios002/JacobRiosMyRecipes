...
{
    public class FavRecipeSQLSvcImpl : IFavoriteSvc
    {
        ...
        public void create(List<Recipe> list, string userName)
        {
            ...
            string testDatabase = "SELECT COUNT(*) FROM FavoriteTable" + userName;
            ...
            try
            {
                ...
                if (count != null && count == "0")
                {
                    foreach (Recipe r in list)
                    {
                        ...
                        command.CommandText = "INSERT INTO FavoriteTable" + userName + " " +
            ...
            catch (SqlException e1)
            {
                ...
                command.CommandText = "CREATE TABLE [FavoriteTable" + userName +"]([Id] INT NOT NULL " +
        ...
        public List<Recipe> retrieveAllRecipes(string userName)
        {
            ...
            command.CommandText = @"SELECT * FROM FavoriteTable" + userName;
        ...
        public void update(Recipe recipe, string userName)
        {
            ...
            dbConnection = new SqlConnection(
                ...
                ConnectionString);
            dbConnection.Open();
            string updateRow = "UPDATE FavoriteTable" + userName + " SET Name = @name, Ingredients " +
                "= @ingredients, Instructions = @instructions WHERE Id = @id";
            SqlCommand command = new SqlCommand(updateRow, dbConnection);
            command.Parameters.AddWithValue("@name", recipe.RecipeName);
            command.Parameters.AddWithValue("@ingredients", recipe.RecipeIngredients);
            command.Parameters.AddWithValue("@instructions", recipe.RecipeInstructions);
        ...
        public void delete(String id, string userName)
        {
            ...
            dbConnection = new SqlConnection(
                ...
                ConnectionString);
            dbConnection.Open();
            string deleteRow = "DELETE FROM FavoriteTable" + userName + " WHERE Id=" + id.ToString() + ";";
        ...
        public void dropTable(string userName)
        {
            ...
            dbConnection = new SqlConnection(
                ...
                ConnectionString);
            dbConnection.Open();
            string deleteTable = "DROP TABLE IF EXISTS FavoriteTable" + userName;
        ...
        public void deleteMultiple(string recipesToDelete, string userName)
        {
            ...
            if (count == 0)
            {
                delete(recipesToDelete, userName);
            }
            ...
            else
            {
                ...
                ConnectionString);
                dbConnection.Open();
                string deleteRows = "DELETE FROM FavoriteTable" + userName + " WHERE Id in (" +
                    recipesToDelete + ");";
